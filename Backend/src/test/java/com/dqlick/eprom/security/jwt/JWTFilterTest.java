package com.dqlick.eprom.security.jwt;

import static org.assertj.core.api.Assertions.assertThat;

import com.dqlick.eprom.management.SecurityMetersService;
...
class JWTFilterTest {
    ...
    void testJWTFilter() throws Exception {
        UsernamePasswordAuthenticationToken authentication = new UsernamePasswordAuthenticationToken(
            "test-user",
            "test-password",
            Collections.singletonList(new SimpleGrantedAuthority(AuthoritiesConstants.STUDY_COORDINATOR))
        );
