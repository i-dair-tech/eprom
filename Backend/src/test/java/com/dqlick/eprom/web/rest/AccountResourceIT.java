...
import static com.dqlick.eprom.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import com.dqlick.eprom.service.dto.PasswordChangeDTO;
import com.dqlick.eprom.service.dto.UserDTO;
import com.dqlick.eprom.web.rest.vm.KeyAndPasswordVM;
import com.dqlick.eprom.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testGetExistingAccount() throws Exception {
        ...
        String entity = null;
        userService.createUser(user, ipAdress , entity);
    ...
    void testRegisterValid() throws Exception {
        ...
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.STUDY_COORDINATOR));
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setAuthorities(Collections.singleton(AuthoritiesConstants.STUDY_COORDINATOR));
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAuthorities(Collections.singleton(AuthoritiesConstants.STUDY_COORDINATOR));
    ...
    void testRegisterDuplicateEmail() throws Exception {
        ...
        String ipAdress = null;
        String entity = null;
        userService.updateUser((new AdminUserDTO(testUser4.get())), ipAdress ,  entity);
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.get().getAuthorities())
            .hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.STUDY_COORDINATOR).get());
    }
