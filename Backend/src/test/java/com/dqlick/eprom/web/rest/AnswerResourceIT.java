...
class AnswerResourceIT {
  ...
  void createAnswer() throws Exception {
    ...
    assertThat(testAnswer.getIsArchived()).isEqualTo(DEFAULT_IS_ARCHIVED);
    assertThat(testAnswer.getArchivedDate()).isEqualTo(DEFAULT_ARCHIVED_DATE);
  }
  ...
  void putNewAnswer() throws Exception {
    ...
    assertThat(testAnswer.getIsArchived()).isEqualTo(UPDATED_IS_ARCHIVED);
    assertThat(testAnswer.getArchivedDate()).isEqualTo(UPDATED_ARCHIVED_DATE);
  }
  ...
  void deleteAnswer() throws Exception {
    ...
    restAnswerMockMvc
      .perform(
        delete(ENTITY_API_URL_ID, answer.getId())
