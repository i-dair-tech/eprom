...
import com.dqlick.eprom.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    void createUser() throws Exception {
        ...
        managedUserVM.setAuthorities(Collections.singleton(AuthoritiesConstants.STUDY_COORDINATOR));
    ...
    void testUserDTOtoUser() {
        ...
        userDTO.setAuthorities(Collections.singleton(AuthoritiesConstants.STUDY_COORDINATOR));
        ...
        assertThat(user.getAuthorities()).extracting("name").containsExactly(AuthoritiesConstants.STUDY_COORDINATOR);
    }
    ...
    void testUserToUserDTO() {
        ...
        authority.setName(AuthoritiesConstants.STUDY_COORDINATOR);
        ...
        assertThat(userDTO.getAuthorities()).containsExactly(AuthoritiesConstants.STUDY_COORDINATOR);
    ...
    void testAuthorityEquals() {
        ...
        authorityA.setName(AuthoritiesConstants.STUDY_COORDINATOR);
        assertThat(authorityA).isNotEqualTo(authorityB);

        authorityB.setName(AuthoritiesConstants.STUDY_COORDINATOR);
